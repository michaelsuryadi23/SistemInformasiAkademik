...
public class Marks  implements java.io.Serializable {
    ...
    public Marks(MarksId id, Matkul matkul, Students students, Periods periods, double nilai1, double nilai2, double nilai3, double nilai4, double nilai5, double uas) {
       this.id = id;
       this.matkul = matkul;
