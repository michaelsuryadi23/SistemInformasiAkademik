...
<html>
    ...
    <body>
        ...
        <div id="content">
            ...
            <h2 style="text-align: center; margin-left: 20px; padding-top: 10px;">Input Mata Kuliah</h2> ---
                    ...
                    <fieldset>
                        <table>
                            <tr><td><label for="username">Matkul ID : </label></td>
                                <td><input type="text" name="matkulID" style="height: 20px; width: 200px"></td>
                            </tr>
                            <tr>
                                <td> <label for="username">Matkul Name : </label></td>
                                <td><input type="text" name="matkulName" style="height: 20px; width: 200px"></td>
                            </tr>
                            <tr>
                                <td> <label for="username">Matkul Type : </label></td>
                                <td><input type="text" name="matkulType" style="height: 20px; width: 200px"></td>
                            </tr>
